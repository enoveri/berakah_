      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white border border-blue-200 rounded-xl shadow-md overflow-hidden mb-12">
            <div className="p-8">
              <h2 className="text-2xl font-semibold mb-6 text-center text-blue-600">How to Join a Cell Family</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="bg-gray-100 p-4 rounded-lg text-center">
                  <h3 className="font-medium mb-2 text-gray-800">Fill out a Connect Card</h3>
                ...
                <div className="bg-gray-100 p-4 rounded-lg text-center">
                  <h3 className="font-medium mb-2 text-gray-800">Visit our Information Desk</h3>
                  <p className="text-sm text-gray-600">
                ...
                <div className="bg-gray-100 p-4 rounded-lg text-center">
                  <h3 className="font-medium mb-2 text-gray-800">Contact Us Online</h3>
                  <p className="text-sm text-gray-600">
