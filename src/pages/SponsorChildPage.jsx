...
const SponsorChildPage = () => {
  return (
    <div className="min-h-screen bg-[#1a1a3a]">
      ...
      <div className="relative bg-[#12122e] text-white">
        <div className="absolute inset-0 bg-black opacity-30"></div>
        <div className="container mx-auto px-4 py-24 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6 text-blue-300">SPONSOR</h1>
            <div className="max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold mb-6 text-blue-200">SPONSOR A LIFE. CHANGE A STORY.</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold text-blue-300 mb-4">Sponsor a Child</h1>
          ...
          <div className="mt-16 text-center">
            <h2 className="text-2xl font-semibold text-blue-300 mb-4">Why Sponsor a Child?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="container-green p-6 rounded-lg shadow-md">
              ...
              <div className="container-purple p-6 rounded-lg shadow-md">
              ...
              <div className="container-blue p-6 rounded-lg shadow-md">
