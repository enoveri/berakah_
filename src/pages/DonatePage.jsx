...
import { FaHandHoldingHeart, FaChild, FaHospital, FaGraduationCap, FaChurch, FaUsers } from 'react-icons/fa';
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {/* Sponsor a Child */}
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow transform transition-all duration-300 hover:scale-105">
              <div className="p-6">
                <div className="flex items-center mb-4">
                  <div className="mr-4 text-blue-600">
                    <FaChild className="text-3xl" />
                  </div>
                  <h3 className="text-xl font-semibold text-gray-800">Sponsor a Child</h3>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow transform transition-all duration-300 hover:scale-105">
              <div className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">Ministry Needs</h3>
                </div>
                <p className="text-gray-600 mb-4">
                ...
                <div className="bg-gray-50 p-4 rounded-md mb-4">
                  ...
                  <ul className="list-disc pl-5 text-gray-600 space-y-1">
                    ...
                    <li>Church planting and evangelism resources</li>
                  </ul>
                </div>
                <Link 
                  to="/ministry-needs" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-xl transition-shadow transform transition-all duration-300 hover:scale-105">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-xl transition-shadow transform transition-all duration-300 hover:scale-105">
              ...
              <h3 className="text-lg font-semibold mb-2 text-center">Church Planting</h3>
              <p className="text-gray-600 text-center">
                Support our efforts to establish new churches in unreached communities.
              </p>
            </div>
          </div>
